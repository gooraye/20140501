...
class AddonsController extends Controller {
	...
	public function execute($_addons = null, $_controller = null, $_action = null) {
		...
		define ( 'ADDON_PUBLIC_PATH', ONETHINK_ADDON_PATH . $_addons . '/View/default/Public' );
	...
	function mobileForm() {
		...
		if (IS_POST) {
			...
			$this->display ( './Application/Front/View/default/Addons/mobileForm.html' );
		}
	}
}
